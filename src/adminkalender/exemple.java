...
public class exemple extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtnip, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 260, 170, -1));
        ...
        getContentPane().add(txtnama, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 300, 170, 30));
        ...
        getContentPane().add(txtjabatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 350, 170, -1));
        getContentPane().add(txtno, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 400, 170, -1));
        ...
        getContentPane().add(txtemail, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 450, 170, -1));
        ...
        getContentPane().add(popup, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 310, 50, -1));
        ...
        getContentPane().add(cover, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -20, 1250, 700));
...
////////        }
    ...
    private void popupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_popupActionPerformed
        // TODO add your handling code here:
         exdesposisi a = new exdesposisi();
        int i = table.getSelectedRow();
        TableModel tbl = table.getModel();
        String  nip = tbl.getValueAt(i, 0).toString();
        String nama = tbl.getValueAt(i, 1).toString();
        String jabatan = tbl.getValueAt(i, 2).toString();
        String no = tbl.getValueAt(i, 3).toString();
        String email = tbl.getValueAt(i, 4).toString();
       
        
        a.txtnip.setText(nip);
        a.txtnama.setText(nama);
        a.txtjabatan.setText(jabatan);
        a.txtno.setText(no);
